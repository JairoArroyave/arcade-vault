...
export function HallOfFameClient({
  ...
  const you = user
    ? rows.find((r) => r.name.toUpperCase() === user.name.toUpperCase())
    : undefined;
  ...
  return (
    <div className="av-hall fade-in">
      ...
      {rows.length === 0 ? (
        <div
          style={{ textAlign: "center", padding: 60, color: "var(--ink-faint)" }}
        >
          <div
            className="pixel"
          ...
          <div>Sé el primero en jugar {game?.title} y guardar tu marca.</div>
        </div>
      ) : (
        <>
