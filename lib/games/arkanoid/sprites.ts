// Mapa de coordenadas portado de
// reference/juegos/04/arkanoid/assets/assets/spritesheet.js — solo los datos;
// la carga/dibujo del spritesheet vive dentro de createArkanoidEngine().
